...
<p class="text-muted small mt-3">Pulling latest posts from Substack. <noscript>Enable JavaScript or visit <a href="{{ site.substack_publication_url | default: site.substack_feed_url | replace:'/feed','' }}">Substack</a>.</noscript></p>
{% else %}
